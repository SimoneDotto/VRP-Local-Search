...
namespace Core
{
template <class State, class Move, class CostStructure = DefaultCostStructure<double>>
...
template <class Input, class State, class Move, class CostStructure = DefaultCostStructure<double>>
class Kicker;
